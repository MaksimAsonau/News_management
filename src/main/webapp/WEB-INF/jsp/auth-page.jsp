...
<%--        /* Основные стили для кнопок и формы */--%>
...
<%--        /* Линия и текст под кнопкой входа */--%>
<%--        .line-container {--%>
<%--            margin: 15px 0;--%>
...
<%--            cursor: pointer;--%>
<%--            transition: background-color 0.3s;--%>
<%--            font-size: 16px; /* Размер шрифта соответствует кнопке "Войти" */--%>
<%--        }--%>
...
<%--            color: red;--%>
<%--            font-size: 16px;--%>
<%--            display: block; /* Убедись, что элемент видим */--%>
<%--        }--%>
<%--    </style>--%>
<%--</head>--%>
<%--<body>--%>
